              ...
              <div className="space-y-3 text-sm">
                ...
                <div>
                  ...
                  <p className="font-medium text-gray-900">
                    ...
                    <br />
                    {request.destinationAddress.city}, {request.destinationAddress.state} {request.destinationAddress.pincode}
                  </p>
                </div>
              </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <div className="mt-3 pt-3 border-t">
                <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                  ...
                  {request.paymentDetails.paymentStatus.charAt(0).toUpperCase() + request.paymentDetails.paymentStatus.slice(1)}
                </span>
              </div>
            </div>
          </div>
